...
public class ProjectCreatedEvent {
    ...
    public ProjectCreatedEvent(String projectId, String tenantId, String projectName, String location, 
                               BigDecimal totalArea, Integer totalLots, LocalDate startDate, 
                               LocalDate estimatedEndDate, String status, LocalDateTime createdAt) {
