...
@Component
public class ConfirmReservationCommandHandler implements Command.Handler<ConfirmReservationCommand, ReservationDto> {
    
    private final ReservationRepository reservationRepository;

    public ConfirmReservationCommandHandler(ReservationRepository reservationRepository) {
