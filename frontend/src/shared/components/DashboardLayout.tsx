...
const DashboardLayout: React.FC<DashboardLayoutProps> = ({ children }) => {
  ...
  const menuItems = [
    ...
    { icon: <Building2 size={20} />, label: 'Proyectos', path: '/mapas' },
    { icon: <Grid size={20} />, label: 'Lotes', path: '/lots' },
    { icon: <Users size={20} />, label: 'Leads', path: '/leads' },
    { icon: <BookmarkCheck size={20} />, label: 'Reservas', path: '/reservations' },
            ...
            <div className="flex items-center gap-2 sm:gap-4">
              ...
              <div className="flex items-center gap-3">
                ...
                <div className="hidden sm:block">
                  ...
                  <p className="text-xs text-slate-500 dark:text-slate-400 mt-1">{user?.role || 'Usuario'}</p>
                </div>
              </div>
            </div>
          </header>
